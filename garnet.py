...
def makedir(directory, dir_name):
    # Takes a parent directory, directory name, permissions as parameters and create a directory at the specified parent directory.
    # Parameters
    # ----------
    # directory : str 
...
if(sys.argv[1] == '--help'):
    ...
    print("mkdir (shell of qarth) 1.0.0")
